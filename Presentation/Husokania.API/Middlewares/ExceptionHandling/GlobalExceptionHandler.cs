...
using Application.Common.Abstractions.Localization;
using Domain.Exceptions;
using Domain.Exceptions.ProblemDetail;
using Domain.Messages;
using System.Net;
using ValidationProblemDetails = Domain.Exceptions.ProblemDetail.ValidationProblemDetails;
